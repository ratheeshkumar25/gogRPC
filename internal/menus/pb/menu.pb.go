...
func (x *MenuResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_menu_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x65, 0x6d, 0x22, 0x56, 0x0a, 0x0c, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x73, 0x70,
	...
	,
...
var file_menu_proto_depIdxs = []int32{
	...
	2, // 1: pbM.MenuService.FetchMenuByID:input_type -> pbM.MenuID
	3, // 2: pbM.MenuService.FetchMenuByName:input_type -> pbM.FoodByName
	0, // 3: pbM.MenuService.FetchMenus:input_type -> pbM.NoParam
	1, // 4: pbM.MenuService.FetchMenuByID:output_type -> pbM.MenuItem
	1, // 5: pbM.MenuService.FetchMenuByName:output_type -> pbM.MenuItem
	4, // 6: pbM.MenuService.FetchMenus:output_type -> pbM.MenuList
